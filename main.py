...
#=============== Importing modules and other dependecies from /src map =============
...
#=============== Importing other python packeges =================================
...
@app.get("/current", response_description="Current User", response_model=ShowUserModel)
...
@app.get(
    "/", response_description="List all users", response_model=List[ShowUserModel]
)
...
@app.get(
    "/{id}", response_description="Get a single user", response_model=ShowUserModel
)
...
@app.put("/{id}", response_description="Update a user", response_model=UpdateUserModel)
async def update_user(id: str, user: UpdateUserModel, current_user: UserModel = Depends(get_current_user)):
